...
const FILES = [
  ...
  { source: 'ccg_coding_domain.py', target: 'ccg-coding-domain', mode: 0o700 },
  { source: 'ccg_coding_domain.py', target: 'ccg_coding_domain.py', mode: 0o600 },
  { source: 'ccg_model_compat.py', target: 'ccg_model_compat.py', mode: 0o600 },
