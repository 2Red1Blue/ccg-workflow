...
describe('installReviewSupervisor', () => {
  ...
  it('uninstalls only files still matching its receipt', async () => {
    ...
    expect(await uninstallReviewSupervisor(install)).toEqual(['ccg-agent-supervisor', 'ccg-task', 'ccg_task_router.py', 'ccg_coding_domain.py', 'ccg_model_compat.py', 'ccg_review_web.py', 'ccg_review_web.html', 'ccg_review_web.js', 'ccg_review_web.css', 'ccg_review_center_poster.webp'])
